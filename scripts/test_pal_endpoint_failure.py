...
import src.agents.instance.pal_agent_controller as pal_controller_module
from src.agents.instance.pal_agent_controller import PALAgentController
from src.pal.invoker import PALInvocationResult, invoke_pal_program
from src.pal.parser import parse_pal_code
...
def main() -> None:
    parsed_program = parse_pal_code(PAL_CODE)

    success_result = invoke_pal_program(
        parsed_program,
    ...
    failure_result = invoke_pal_program(
        parsed_program,
    ...
    def run_controller_case(invocation_result: PALInvocationResult) -> tuple[str, dict, list[dict]]:
        original_execute = pal_controller_module.execute_pal_code_with_result
        pal_controller_module.execute_pal_code_with_result = lambda code: invocation_result
        try:
            controller = PALAgentController(language_model=_FakeLanguageModel())
            events: list[dict] = []
            ...
            pal_controller_module.execute_pal_code_with_result = original_execute
    ...
    print(json.dumps(
        {
            ...
            "events": [
                ...
                in {
                    "toolgen_smoke_test",
                    "pal_adapter_artifact_classified",
                    "pal_adapter_materialization_selected",
                    "pal_adapter_bridge_emitted",
                }
            ],
        },
        indent=2,
    ...
    selected_events = [
        ...
        in {
            ...
            "pal_controller_execution_fallback_used",
            "pal_adapter_artifact_classified",
            "pal_adapter_materialization_selected",
            "pal_adapter_bridge_emitted",
        }
