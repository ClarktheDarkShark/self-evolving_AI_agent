...
class _DummySparqlExecutor:
    def execute_query(self, _query: str):
        raise AssertionError("Synthetic PAL artifacts should bypass SPARQL execution.")

    def get_endpoint_url(self) -> str:
        return "dummy://pal-adapter-test"


def _load_bridge_runner():
    namespace: dict[str, object] = {}
    exec(build_pal_benchmark_bridge_tool_code(), namespace, namespace)
...
def _run_case(
    *,
    ...
    context = BenchmarkAdapterContext(
        ...
        state_dir="/tmp/pal_adapter_test",
    )
