ORCHESTRATOR_SYSTEM_PROMPT = """You are a routing mechanism for a Program-Aided Language (PAL) knowledge graph agent.
...
SOLVER_SYSTEM_PROMPT = """You are the final answer solver for a Program-Aided Language (PAL) knowledge graph agent.
