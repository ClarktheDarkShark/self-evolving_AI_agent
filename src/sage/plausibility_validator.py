"""
SAGE Plausibility Validator
==========================
Leakage-safe, heuristic validator for SAGE candidates *after* execution.
...
def validate_sage_execution(
    *,
    ...
    """
    Heuristic plausibility check for a SAGE candidate after execution on the
